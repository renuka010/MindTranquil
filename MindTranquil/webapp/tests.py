...
class RegistrationTest(TestCase):
    def setUp(self):
        """
        Set up the client and the registration url
        """
        self.client = Client()
    ...
    def test_registration_failure(self):
        """
        Test if the registration fails when the username is empty
        """
        response = self.client.post(
            self.register_url,
            {
        ...
        self.assertEqual(
            str(messages[0]), "There was a problem with your registration."
        )
...
class LoginTest(TestCase):
    def setUp(self):
        """
        Set up the client and the login url. Also create a test user
        """
        self.client = Client()
    ...
    def test_login_success(self):
        ...
        self.assertEqual(response.status_code, 302)  # Check if redirect
        self.assertEqual(
            int(self.client.session["_auth_user_id"]), self.test_user.pk
        )  # Check if user is logged in

    def test_login_failure(self):
        """
        Test if the login fails when the username is wrong
        """
        response = self.client.post(
            self.login_url,
            {
...
class LogoutTest(TestCase):
    def setUp(self):
        """
        Set up the client and the logout url. Also create a test user and log them in
        """
        self.client = Client()
    ...
    def test_logout(self):
        """
        Test if the logout is successful
        """
...
class ViewTest(TestCase):
    def setUp(self):
        """
        Set up the client and the test user. Also create a UserStats for the user
        """
        self.client = Client()
        self.test_user = get_user_model().objects.create_user(
            username="testuser",
        ...
        self.user_stats = UserStats.objects.create(
            user=self.test_user
    ...
    def test_breathe(self):
        """
        Test if the breathe page is rendered correctly
        """
    ...
    def test_meditate(self):
        """
        Test if the meditate page is rendered correctly
        """
        response = self.client.get(reverse("webapp:meditate"))
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response.context["music_types"],
            {0: "No Sound", 1: "Fireplace", 2: "Rain in Forest", 3: "Rain", 4: "River"},
        )

    def test_stats(self):
        """
        Test if the stats page is rendered correctly
        """
    ...
    def test_play_music(self):
        """
        Test if the play_music page is rendered correctly
        """
    ...
    def test_play_session(self):
        """
        Test if the play_session page is rendered correctly
        """
...
class APITest(TestCase):
    ...
    def test_update_mode_api(self):
        """
        Test if the update_mode_api works correctly
        """
        response = self.client.post(
            reverse("webapp:update_mode_api"), {"preferred_mode": "dark"}
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_update_session_api(self):
        """
        Test if the update_session_api works correctly
        """
        session_data = {
        ...
        response = self.client.post(
            reverse("webapp:update_session_api"),
            json_data,
    ...
    def test_get_active_days_api(self):
        """
        Test if the get_active_days_api works correctly
        """
        ...
        response = self.client.get(
            reverse("webapp:get_active_days_api"),
